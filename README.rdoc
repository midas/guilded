...
Add to environment file:
  ...
  config.gem "guilded", :version => '0.1.7'
...
There is a single view helper to apply the JavaScript and CSS.  You can place this at the bottom of your layouts (so you
do not have to include it in every template):

  <%= g_apply_behavior %>

You also must reset the Guilded singleton that manages everything after each renderring.  The best way to do this is a before 
filter in your applicaiton controller:
